...
Later:
  - gex        — SqueezeMetrics gamma exposure (parses the `gex` column of the
                 same DIX.csv we already ingest for DIX)
...
"""
from tide.metrics.tier4 import aaii, cot_sp, dix, gex, vix_term  # noqa: F401
